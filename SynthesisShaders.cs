...
namespace MIDI
{
    ...
    public readonly partial struct WaveformGenerationShader : IComputeShader
    {
        ...
        public WaveformGenerationShader(ReadWriteBuffer<float> buffer, ReadOnlyBuffer<GpuNoteData> notes, int noteCount, int sampleRate, int offset,
                                        float fmModulatorFrequency, float fmModulationIndex, bool enableBandlimited)
        {
            this.buffer = buffer;
            this.notes = notes;
